...
import { ContractFilters } from '@/components/admin/contracts/ContractFilters';
    ...
    <AdminLayout>
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-900">Gestão de Contratos 📋</h1>
            <p className="text-slate-500">Acompanhe todas as contratações da plataforma</p>
          </div>
